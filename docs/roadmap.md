...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Five observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Candidate adjudication after #275 is staged through #277, and #278 now preserves active-duration accounting; #75 and #250 remain blocked |
...
restart boundaries. Keep #75 unvalidated and leave #250 blocked pending an
explicit candidate adjudication decision.
