...
application command now applies one explicitly selected source through exactly
one bounded scan: a unique exact-integrity missing-member match advances the
member revision, while an already-current source is reverified as a guarded
no-op. It accepts no target path and returns only frozen, path-free
`moved`/`current` status. Complete reconciliation under #135, lifecycle
readiness under #136, automatic inference, physical deletion, adapters,
indexing, and background refresh remain deferred.
...
relationships, and indexing state. Source addition, update, removal, bounded
directory re-intake, incremental directory refresh, retention, deletion, backup,
and restore must apply consistently to raw
...
| Date       | Change                                                                                                                                                                                                                                       | Reason                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-23 | Added the explicit one-source directory-member move command as the nineteenth bounded #110 / second and completing #134 slice without advancing the v0.7 stage beyond component implementation | One complete bounded scan now selects either the requested current member or one unique exact-integrity missing-member match, then the verified v15 handle applies the move or a guarded no-op. The command accepts no target path, returns only frozen path-free `moved`/`current` status, and keeps #135/#136, automatic inference, physical deletion, adapters, indexing, and background refresh pending. |
