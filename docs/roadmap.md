...
| Portable CKB                       | [Released Sprint 2 checkpoint](stage-evidence-v0.7.0-alpha.2.md); v0.7 incomplete/unvalidated | The separate local store has coordinated writers, recoverable owned writes, explicit six-class retention planning, and portable backup/restore with integrity and collision checks. Shared CLI/desktop application contracts keep sensitive origins private. Confirmed deletion remains an unmilestoned backlog outcome. |
...
| Next     | Independent review and readiness ([milestone v0.8.0](https://github.com/akoita/draft-loop/milestone/3))           | Designed; #71 report contract and first #72 adjudication/trace contract component implemented; runtime integration blocked | Turn the factual draft into a reviewed, revised, human-approvable artifact            | #69/#70 drafting dependencies, then structured critique, adjudication, calibrated readiness gates, and professional rendering |
...
diff, and effect helpers. Runtime, persistence, provider, CLI, and desktop
integration—and the v0.8 outcome—remain blocked on the complete drafting and
writing-policy dependencies in #69 and #70. The v0.8 stage remains Next and incomplete;
these components do not claim the milestone is complete.
