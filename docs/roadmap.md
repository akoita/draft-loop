...
| Now      | Author-draft acceptance reliability                                                                               | [Supported-paraphrase correction](evaluation/author-draft-acceptance-reliability.md) moves the unchanged replay corpus from 2/6 to 3/6 accepted | Produce complete, supported drafts reliably enough to justify a new cohort            | Make bounded retry feedback actionable without weakening negative controls |
