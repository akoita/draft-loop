...
application operations now create, reload, list, edit, and review immutable
...
URL-free projection. Exact reviewed-version planning handoff remains open. #67
and the milestone remain incomplete.
