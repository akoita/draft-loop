...
| Now      | Author-draft acceptance reliability                                                                               | [Six-case replay baseline](evaluation/author-draft-acceptance-reliability.md) frozen; live case A rejected | Produce complete, supported drafts reliably enough to justify a new cohort            | Correct the supported-paraphrase false rejection and retry feedback without weakening negative controls |
