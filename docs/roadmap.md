...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Three observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Run another authorized comparison (#75) next, then release evidence and next decision (#76); #250 remains blocked |
...
comparison is next, and #250 remains blocked pending that result.
