...
| Opportunity brief                  | Implemented contract component        | A strict provider-independent draft/review contract keeps typed sources, provenance, requirements, candidate instructions, and unresolved source issues distinct. Persistence, secure multi-source intake, editing/review adapters, and exact reviewed-version planning handoff remain open.                                                                                                                                               |
...
exact reviewed brief version into run planning remain follow-up work. The
current job-description path and provider context are unchanged.
