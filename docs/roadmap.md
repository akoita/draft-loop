...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Twenty-one observations across two consented cases are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | #350 informed corrections #351/#352; #358/#360 hit rate limits, and #362/#364/#368 failed before a draft. #368 exercised #366 but output-budget failures persisted. After #370/#372, #374 exhausted three author attempts across output-budget and factuality failures. #376 corrects per-generation cap accounting; #378 had one non-retryable `unknown` author failure. #380 adds content-free attribution for statusless Claude result errors. No artifact or review; #75/#250 remain blocked |
