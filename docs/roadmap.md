...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Six observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Resolve the multi-run artifact-history blocker #287, then review the materially different #286 findings; #75 and #250 remain blocked |
