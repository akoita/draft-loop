...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [One consented result is indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Complete consented comparison (#75) after bounded provider-timeout support, then release evidence and next decision (#76) |
...
comparison. Keep #75 open and #250 blocked until a complete consented result is
recorded after bounded timeout support and fresh transmission approval.
