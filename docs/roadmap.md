...
| Now      | Structured-block author guidance ([milestone](https://github.com/akoita/draft-loop/milestone/15))                | #488 merged; [#489 and #493 indeterminate](evaluation/structured-block-author-guidance.md): preflight `api-error`, then author `max_tokens` under the v2 prompt | Get the author to copy and claim structured fields verbatim from evidence             | The user decides between a larger output budget, more compact guidance, or stopping |
