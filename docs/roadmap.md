...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Five observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Complete candidate adjudication after #275; #277 is delivered and enables #278, while #75 and #250 remain blocked |
...
revision, approval, export, or submission occurred. Issue #277 now stages the
candidate's exact adjudication through the shared application/local boundary
and is the prerequisite for #278 duration accounting. Keep #75 unvalidated
and leave #250 blocked pending an explicit candidate adjudication decision.
