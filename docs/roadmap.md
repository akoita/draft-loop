...
2. **Quality, standard frontier pair.** After a separate stage decision, use
   ...
   to chronology-covered Experience and narrows priority retrieval. A passing
   quality observation enables a separate
