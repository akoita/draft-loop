...
lifecycle controls, retrieval enforcement, and drafting integration.
...
- Retrieval and index-version enforcement of bound CKB selection snapshots,
  ...
  backup/export/restore, remaining directory lifecycle adapters, and
