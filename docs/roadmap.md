...
| Now      | Structured-block author guidance ([milestone](https://github.com/akoita/draft-loop/milestone/15))                | #488 merged; [#489 indeterminate](evaluation/structured-block-author-guidance.md): author preflight `api-error` before any material was sent | Get the author to copy and claim structured fields verbatim from evidence             | The author route decision (retry, model change, or diagnosis) returns to the user |
