...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Six observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Land the implemented multi-run artifact-history fix #287, then review the materially different #286 findings; #75 and #250 remain blocked |
...
the workspace already held version 1; #287 owns that storage blocker. Keep #75
unvalidated and leave #250 blocked pending #287 and explicit review of the new
findings.
