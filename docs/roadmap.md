...
| Now      | Workflow parity and release ([milestone v0.9.0](https://github.com/akoita/draft-loop/milestone/4)) | [Five observations of one consented case are indeterminate](consented-pilot-v0.9.md); parity not validated | Demonstrate the complete application-grade workflow and publish evidence              | Complete candidate adjudication after #275, then continue #75 only with an explicit decision; #250 remains blocked |
...
with eight warnings and one unresolved factuality error, so no adjudication,
revision, approval, export, or submission occurred. Keep #75 unvalidated and
leave #250 blocked pending an explicit candidate adjudication decision.
...
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-01 | Recorded the post-citation-completion observation under #275 as indeterminate. | Both provider roles completed on their first attempts, but readiness stopped on eight warnings and one unresolved factuality error. Candidate adjudication is the next explicit boundary; #75 stays open and #250 remains blocked. |
