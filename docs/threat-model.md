...
- portable continuity for the local CKB origin binding, background refresh,
  ...
  applied directory refresh and membership lifecycle, URL redirect-history/conditional-request readiness,
